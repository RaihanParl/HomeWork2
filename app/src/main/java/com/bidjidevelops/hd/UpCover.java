...
public class UpCover extends AppCompatActivity implements View.OnClickListener{
    ...
    * */
    public void uploadMultipart() {
        ...
        try {
            ...
            new MultipartUploadRequest(this, uploadId, Helper.BASE_URL+"editcoverimg.php")
